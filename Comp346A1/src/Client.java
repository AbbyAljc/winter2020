...
public class Client extends Thread { 
    ...
    {   
    	...
    	if(this.getClientOperation() == "sending") {
    	...
    	else if (this.getClientOperation() == "receiving") {
    	
    	receiveClientStartTime = System.currentTimeMillis();
    	receiveTransactions(transact);
		receiveClientEndTime = System.currentTimeMillis();
		
		System.out.println("\n Terminating client recieving thread - " + "Running time " + (receiveClientEndTime - receiveClientStartTime)+ " milliseconds");
